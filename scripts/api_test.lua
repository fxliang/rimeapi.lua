...
assert(rime_api:change_page(session, false) == true)
assert(rime_api:change_page(session, true) == true)
...
assert(rime_api:config_get_cstring(config, "a_string") == "a_string")
assert(rime_api:config_get_cstring(config, "nonexistent_key") == nil)
print('rime_api:config_get_cstring passed')
assert(rime_api:config_get_string(config, "a_string", 256) == "a_string")
print('rime_api:config_get_string passed')
assert(rime_api:config_get_string(config, "a_string") == "a_string")
print('rime_api:config_get_string without buffer size passed')
assert(rime_api:config_get_string(config, "nonexistent_key") == nil)
...
assert(rime_api:config_get_int(config, 'a_int') == 10)
...
assert(rime_api:config_get_int(config, 'nonexistent_key') == nil)
...
assert(rime_api:config_get_double(config, 'a_double') == 520.233)
...
assert(rime_api:config_get_double(config, 'nonexistent_key') == nil)
...
assert(rime_api:config_get_bool(config, 'a_bool') == true)
...
assert(config:get_bool('nonexistent_key') == nil)
print('RimeConfig:get_bool for nonexistent key passed')
assert(rime_api:config_get_bool(config, 'nonexistent_key') == nil)
...
if rime_api:config_begin_map(iter, config, "a_map") then
  ...
  while rime_api:config_next(iter) do
    local str = rime_api:config_get_string(config, iter.path, 256)
...
assert(rime_api:config_get_string(config_to_clear, "new_list/@0", 256) == "new_item1")
assert(rime_api:config_get_string(config_to_clear, "new_list/@1", 256) == "new_item2")
...
assert(rime_api:config_get_string(config_to_clear, "new_map/key1", 256) == "value1")
assert(rime_api:config_get_int(config_to_clear, "new_map/key2") == 233)
